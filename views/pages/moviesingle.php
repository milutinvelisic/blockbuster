		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="assets/images/uploads/<?= $movie->mainCatInfoBigPhoto ?>" alt="<?= $movie->mainCatInfoName ?>">
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical red">
							<div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> Watch Trailer</a></div>
							<div><a href="<?= $movie->mainCatInfoTrailer ?>" class="item item-2 redbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
						</div>
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					<h1 class="bd-hd"><?= $movie->mainCatInfoName ?></h1>
					<?php
						        ...
						        <div id="overview" class="tab active">
						            <div class="row">
						            	...
						            	<div class="col-md-4 col-xs-12 col-sm-12">
						            		...
						            		<div class="sb-it">
						            			<h6>Release Date:</h6>
						            			<p><?= $movie->mainCatInfoReleaseDate ?></p>
						            		</div>
						            		<div class="sb-it">
						            			<h6>Run Time:</h6>
						            			<p><?= $movie->mainCatInfoRuntime ?> min</p>
						            		</div>
						            		<div class="sb-it">
						            			<h6>MMPA Rating:</h6>
						            			<p>
												<?php
													foreach($movie->ageRes as $ar):
												?>
						            			<p><?= $ar->ageResName ?></p>
												<?php
													endforeach;
