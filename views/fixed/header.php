    ...
    <div class="login-content">
        ...
        <form action="models/users/login.php" method="POST" onSubmit="return checkLogin();" >
        	<div class="row">
        		 <label for="username">
                    Username:
                    <input type="text" name="logusername" id="username" placeholder="Hugh Jackman"  required="required" />
                </label>
        	</div>
    ...
    <div class="login-content">
        ...
        <form action="models/users/register.php" method="POST" onSubmit=" return checkRegister();">
            ...
            <div class="row">
                <label for="email-2">
                    your email:
                    <input type="password" name="regemail" id="regemail" placeholder=""  required="required" />
                </label>
            </div>
             <div class="row">
		...
		<nav class="navbar navbar-default navbar-custom">
				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav flex-child-menu menu-right">  
                        ...
                        ?>
						    <span class="welcomeime">Welcome <?= $_SESSION['user']->username ?></span><li><a href="index.php?p=userprofile">profile</a></li>
